...
1. Select the default Spark runtime. You can choose between Spark 3.3, and Spark 3.4 runtimes. The runtime pre-installs the spatio-temporal, data skipping and Paquet modular encryption packages by default.
