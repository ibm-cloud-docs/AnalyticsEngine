...
For a description of the available APIs, see the [{{site.data.keyword.iae_full_notm}} REST APIs for the serverless plan](https://cloud.ibm.com/apidocs/ibm-analytics-engine-v3#introduction).
